...
<head>
    ...
    <script src="dist/js/anular_factura.js?v=<?php echo $version ?>"></script>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Anular Factura</li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label class="col-form-label text-danger font-weight-bold" for="input-num-factura">N° de Factura a ANULAR:</label>
                                    ...
                                    <tbody>
                                        <tr class="pedido-vacio-msg">
                                            <th scope="row" colspan="8" class="text-center"><span class="text-muted">
                                                    Agrega Productos a la Nota de Crédito</span>
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div class="modal-vistaprevia-wrapper">
                    <div class='box box-primary mb-0'>
                        <div class="modal-header d-block">
                            ...
                            <div class="row pt-3 row-select-folio">
