...
<head>
    ...
    <script src="dist/js/guia_despacho.js?v=<?php echo $version ?>"></script>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Nueva Guía de Despacho</li>
                    </ol>
                </section>
                <!-- Main content -->
                            ...
                            <div class="container">
                                <div class="row mt-2">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="search" autocomplete="off" class="form-control w-100 lg-w-75 input-rut"
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <select id="select-condicion" class="selectpicker" data-dropup-auto="false"
                                            title="Selecciona" data-width="100%" data-style="btn-info">
                            ...
                            <div class="container">
                                <div class="row mt-2">
                                    <div class="col-md-6 form-group">
                                        <label class="col-form-label" for="input-rut-transporte">R.U.T. Transporte:</label>
                                        <input type="search" autocomplete="off" class="form-control w-100 lg-w-75 input-transporte input-rut"
                                            name="input-rut-transporte" id="input-rut-transporte" maxlength="10" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="col-form-label" for="input-patente">Patente Transporte:</label>
                                        <input type="search" autocomplete="off" class="form-control w-100 lg-w-75 input-transporte"
                                            name="input-patente" id="input-patente" maxlength="10" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label class="col-form-label" for="input-rut-chofer">R.U.T. Chofer:</label>
                                        <input type="search" autocomplete="off" class="form-control w-100 lg-w-75 input-transporte input-rut"
                                            name="input-rut-chofer" id="input-rut-chofer" maxlength="10" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="col-form-label" for="input-nombre-chofer">Nombre Chofer:</label>
                                        <input type="search" autocomplete="off" class="form-control w-100 lg-w-75 input-transporte"
                                            name="input-nombre-chofer" id="input-nombre-chofer" maxlength="40" />
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <button id="btn-guardar-transporte" onclick="guardarCambiosTransporte()"
                                            class="btn btn-success d-none pull-right"><i class="fa fa-save"></i> GUARDAR CAMBIOS
                                            TRANSPORTE</button>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    <tr class="pedido-vacio-msg">
                                        <th scope="row" colspan="8" class="text-center"><span class="text-muted">
                                                Agrega Productos a la Guía de Despacho</span>
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
