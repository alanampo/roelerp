    ...
    <div class="modalpago-content">
        ...
        <div class="form-row">
            <div class="col-md-12 form-group">
                <label class="col-form-label" for="input-monto">Comprobante de Pago: <button
                        onclick="$('#input-comprobante').val('')" class="btn btn-sm btn-secondary ml-1"><i
                            class="fa fa-times"></i></button></label>
                <input type="file" id="input-comprobante" accept=".pdf,.jpg,.jpeg,.png">
            </div>
        </div>
        <div class="row">
            <div class="col">
