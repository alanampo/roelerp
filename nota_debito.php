...
<head>
    ...
    <script src="dist/js/nota_debito.js?v=<?php echo $version ?>"></script>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Nota de Débito</li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="search" autocomplete="off" class="form-control w-100 lg-w-75" name="input-rut" id="input-rut"
                                    maxlength="20" />
                            </div>
                            <div class="col-md-4 form-group">
                                <label class="col-form-label" for="input-razon">Razón Social:  <button class="btn btn-sm btn-secondary pb-0 pt-0" onclick="setRazonSocial2()">=</button></label>
                                <input type="search" autocomplete="off" class="form-control w-100 lg-w-75" name="input-razon"
                                    id="input-razon" maxlength="50" />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="search" autocomplete="off" class="form-control w-100 lg-w-75" name="input-domicilio"
                                    id="input-domicilio" maxlength="50" />
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control w-100 lg-w-75" name="input-giro"
                                    id="input-giro" maxlength="80" />
                            </div>
                            <div class="col-md-4 form-group">
                            ...
                            <div class="col-md-2 form-group">
                                <label class="col-form-label text-danger font-weight-bold" for="input-num-factura">NC a ANULAR:</label>
                                <select id="select-nc" class="selectpicker w-100 lg-w-75" title="NC A ANULAR"
                                    data-style="btn-info" data-dropup-auto="false"
                                    data-width="100%" data-size="5" ></select>
                                <!--<input style="font-size:1.2em;font-weight-bold" type="search" autocomplete="off" class="form-control w-50" name="input-num-factura"
                                    id="input-num-factura" maxlength="10" />-->
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        <tr class="pedido-vacio-msg">
                                            <th scope="row" colspan="8" class="text-center"><span class="text-muted">
                                                    Agrega Productos a la Nota de Débito</span>
                                            </th>
                                        </tr>
                                    </tbody>
                                </table>
